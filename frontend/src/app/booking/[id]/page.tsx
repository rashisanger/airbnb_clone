      ...
      <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800 sm:p-10">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl bg-gray-50 p-4 dark:bg-gray-900">
            ...
            <p className="mt-2 text-lg font-semibold">{booking.check_in}</p>
          </div>
          ...
          <div className="rounded-xl bg-gray-50 p-4 dark:bg-gray-900">
            ...
            <p className="mt-2 text-lg font-semibold">{booking.check_out}</p>
          </div>
          ...
          <div className="rounded-xl bg-gray-50 p-4 dark:bg-gray-900">
            ...
            <p className="mt-2 text-lg font-semibold">{booking.num_guests}</p>
          </div>

          <div className="rounded-xl bg-gray-50 p-4 dark:bg-gray-900">
            <p className="text-sm font-medium">Booking ID</p>
            <p className="mt-2 text-lg font-semibold">#{booking.id}</p>
          </div>
        </div>
